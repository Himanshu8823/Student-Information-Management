        ...
        <div id="content">
            ...
            <div class="main-content">
                <div class="container bg-white">
                    <h1 class="mt-5 text-gray text-left">View Results</h1>
                    <div class="table-responsive mt-5">
                        <table class="table table-bordered table-striped mt-4 mb-4 pb-4" name="result_table"
                            id="result_table">
                            ...
                            <tbody>
                                <?php
                                // SQL Query to fetch student data who have results
                                $query = "
                                SELECT 
                                ...
                                WHERE EXISTS (
                                    SELECT 1 
                                    FROM results 
                                    WHERE results.ID = tblstudent.ID
                                )
                            ";
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        echo "<tr>
                                                ...
                                                <td>
                                                    <a target='_BLANK' href='view_student_result.php?student_id={$row['StudentID']}' class='btn btn-primary btn-sm'>View Result</a>
                                                </td>
                                            </tr>";
                                    }
                                } else {
                                    echo "<tr>
                                                <td colspan='5' class='text-center'>No students with results found</td>
                                            </tr>";
                                        }
                                ?>
                            </tbody>
