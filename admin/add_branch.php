        ...
        <div id="content">
            ...
            <div class="main-content">
                <div class="container bg-white">
                    <h1 class="mt-5 text-gray text-left">Add Branch</h1>

                    
                     <center>
                        <button class="btn btn-success mt-5 mb-5 " data-toggle="modal" data-target="#editBranchModal">Add Branch</button>
                    </center>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editBranchModalLabel">Add Branch</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="add_new_branch.php" method="POST">
